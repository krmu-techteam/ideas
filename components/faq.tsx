...
export default function Faq() {
  ...
  return (
    <section
      id="faq"
      className="py-16 bg-[#fffefb] faq-section"
    ...
    >
      <div className="container mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div className="border-t border-[#e7ded1]" suppressHydrationWarning>
          {filteredFaqs.map((faq, index) => {
            const isOpen = openIndex === index;
            return (
              <div
                key={faq.question}
                className="border-b border-[#e7ded1] transition-colors"
              >
                <button
                  type="button"
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <p className="pb-5 pt-1 text-[15px] sm:text-[15.5px] leading-[1.65] text-[#6b6357] whitespace-pre-line">
                        {faq.answer}
                      </p>
                    </motion.div>
                  )}
        ...
        {filteredFaqs.length === 0 && (
          <div className="py-12 text-center border-b border-[#e7ded1]">
        ...
        <div className="mt-12 pt-8 border-t border-[#e7ded1] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h3 className="font-serif text-[18px] font-bold text-[#14100b]">
              Still have questions?
            </h3>
            <p className="text-[14px] text-[#6b6357] mt-0.5">
