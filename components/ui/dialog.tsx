      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="text-slate-500 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 p-1.5 rounded-full absolute top-4 right-4 opacity-80 transition-opacity hover:opacity-100 focus:outline-hidden disabled:pointer-events-none [&_svg]:size-4"
          >
            <XIcon />
