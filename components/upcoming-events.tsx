      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#e7ded1] pb-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <Link
              href="/all-events"
              className="inline-flex items-center gap-2 text-[13.5px] font-mono font-semibold uppercase tracking-wider text-[#ea580c] hover:text-[#c2410c] transition-colors"
            >
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-3.5">
          <Link
            href="/all-events"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-[6px] bg-[#ea580c] px-7 py-3 text-[14px] font-medium text-white shadow-xs transition-colors hover:bg-[#c2410c]"
          >
          ...
          >
            ...
            <ArrowRight size={16} className="text-[#ea580c]" />
          </Link>
        </div>
      </div>
    </section>
