      ...
      <div className="bg-gradient-to-br from-green-500 to-emerald-600 text-white py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Extension</h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-16">
            <Card className="!bg-white border border-slate-200/90 shadow-xl text-slate-900">
              <CardContent className="p-8">
                <h2 className="text-2xl font-bold mb-4 text-slate-900">Extend Your Impact</h2>
                <p className="text-slate-600 mb-6 max-w-xl mx-auto">
                  Connect your academic work with real-world applications on October 27–28, 2026 at K.R. Mangalam University.
                </p>
