                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col p-5">
                      ...
                      <h3 className="font-serif mt-3 text-[18px] font-bold leading-snug tracking-[-0.015em] text-[#14100b] transition-colors line-clamp-2 ">
                        {event.title}
                      </h3>
                      ...
                      {/* Time Row */}
                      {event.time && (
                        <div className="mt-3 flex items-center gap-1.5 text-[11.5px]  font-mono">
                      ...
                      <div className="mt-3 pt-3 border-t border-[#f0eae1] flex items-center justify-between text-[12px] text-[#78716c]">
                        ...
                        <span className="inline-flex items-center text-[12.5px] font-semibold text-[#14100b]  transition-colors">
                          Details
