    ...
    <div className="min-h-screen bg-[#fffefb] text-[#14100b] selection:bg-[#ea580c]/20 selection:text-[#ea580c]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        style={{ outline: "none" }}
                        className="h-11 w-full rounded-[6px] border border-[#e7ded1] bg-[#fffefb] px-3.5 text-[14px] text-[#14100b] placeholder:text-[#8c8273] shadow-2xs outline-none focus:outline-none focus-visible:outline-none focus:border-[#ea580c] focus-visible:border-[#ea580c] focus:ring-1 focus:ring-[#ea580c] focus-visible:ring-1 focus-visible:ring-[#ea580c] transition-colors"
                      />
                    </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      style={{ outline: "none" }}
                      className="w-full rounded-[6px] border border-[#e7ded1] bg-[#fffefb] p-3.5 text-[14px] leading-[1.6] text-[#14100b] placeholder:text-[#8c8273] shadow-2xs outline-none focus:outline-none focus-visible:outline-none focus:border-[#ea580c] focus-visible:border-[#ea580c] focus:ring-1 focus:ring-[#ea580c] focus-visible:ring-1 focus-visible:ring-[#ea580c] transition-colors resize-y min-h-[140px]"
                    />
                  </div>

                  <button
                    type="submit"
                    className="font-serif h-11 w-full rounded-[3px] bg-[#ea580c] hover:bg-[#c2410c] text-white font-semibold text-[15px] transition-colors flex items-center justify-center gap-2 shadow-2xs cursor-pointer"
                  >
                    <Send size={15} />
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3.5 p-3 rounded-[6px] bg-[#f4ede1]/60 border border-[#e7ded1]">
                    <div className="w-9 h-9 rounded-[4px] bg-white text-[#ea580c] border border-[#e7ded1] flex items-center justify-center shrink-0 mt-0.5 shadow-2xs">
                      <MapPin size={17} />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3.5 p-3 rounded-[6px] bg-[#f4ede1]/60 border border-[#e7ded1]">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-[#ea580c] hover:underline transition-colors font-semibold text-xs sm:text-sm"
                      >
                        0124-2867800
                      </a>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-[#14100b] text-xs sm:text-sm font-semibold">
                        <a
                          ...
                          className="text-[#ea580c] hover:underline transition-colors"
                        >
                          08800697010-15
                        </a>
                        {" | "}
                  ...
                  <div className="flex items-start gap-3.5 p-3 rounded-[6px] bg-[#f4ede1]/60 border border-[#e7ded1]">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-[#14100b] hover:text-[#ea580c] underline transition-colors font-semibold text-xs sm:text-sm"
                      >
                  ...
                  <div className="flex items-start gap-3.5 p-3 rounded-[6px] bg-[#f4ede1]/60 border border-[#e7ded1]">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-[#ea580c] hover:underline transition-colors font-semibold text-xs sm:text-sm break-all"
                      >
      ...
      >
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 text-center">
          <div className="font-mono text-[11px] font-semibold uppercase tracking-[0.16em] text-[#ea580c] mb-3">
            IDEAS 4.0
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a
              href="/register"
              className="font-serif inline-flex items-center justify-center rounded-[3px] px-8 py-3 text-sm font-semibold transition-colors bg-[#ea580c] text-white hover:bg-[#c2410c] shadow-xs"
            >
