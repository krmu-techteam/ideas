...
const RegisterCTA = dynamic(() => import("@/components/register-cta"), { ssr: true })
const ExploreEvents = dynamic(() => import("@/components/explore-events"), { ssr: true })

// Lazy load: Below-the-fold sections
const LazyIdeasGlance = dynamic(() => import("@/components/ideas-glance"), { loading: () => <div className="py-16" /> })
const LazyEventTimeline = dynamic(() => import("@/components/event-timeline"), {
  loading: () => <div className="py-16" />,
})
const LazyAboutKrmu = dynamic(() => import("@/components/about-krmu"), { loading: () => <div className="py-16" /> })
const LazyZonesHighlights = dynamic(() => import("@/components/zones-highlights"), {
  loading: () => <div className="py-16" />,
})
const LazyUpcomingEvents = dynamic(() => import("@/components/upcoming-events"), {
  loading: () => <div className="py-16" />,
})
const LazyIncubationHub = dynamic(() => import("@/components/incubation-hub"), {
  loading: () => <div className="py-16" />,
})
const LazyFaq = dynamic(() => import("@/components/faq"), { loading: () => <div className="py-16" /> })
...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <div id="faq" style={{ contentVisibility: "auto", containIntrinsicSize: "700px" }}>
        <LazyFaq />
      </div>
